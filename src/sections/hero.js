export function renderHero(lang, translations) {
  ...
  const contacts = [
    { label: 'LinkedIn', href: 'https://www.linkedin.com/in/pedro-augusto-ribeiro', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6zM2 9h4v12H2z"></path><circle cx="4" cy="4" r="2"></circle></svg>' },
    { label: 'GitHub', href: 'https://github.com/ribeiroaugustopedro', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 19c-5 1.5-5-2.5-7-3m14 6v-3.87a3.37 3.37 0 0 0-.94-2.61c3.14-.35 6.44-1.54 6.44-7A5.44 5.44 0 0 0 20 4.77 5.07 5.07 0 0 0 19.91 1S18.73.65 16 2.48a13.38 13.38 0 0 0-7 0C6.27.65 5.09 1 5.09 1A5.07 5.07 0 0 0 5 4.77a5.44 5.44 0 0 0-1.5 3.78c0 5.42 3.3 6.61 6.44 7A3.37 3.37 0 0 0 9 18.13V22"></path></svg>' },
    { label: 'Email', href: 'mailto:ribeiroaugustopedro@gmail.com', icon: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>' }
  ];
  contacts.forEach(c => {
    ...
    btn.addEventListener('mouseenter', () => { btn.style.background = 'linear-gradient(90deg, rgba(255, 0, 0, 0.1), rgba(0, 255, 0, 0.1), rgba(0, 0, 255, 0.1))'; btn.style.backgroundSize = '200% 200%'; btn.style.animation = 'rainbowSlide 2s linear infinite'; btn.style.transform = 'translateY(-2px)'; });
    btn.addEventListener('mouseleave', () => { btn.style.background = 'rgba(255, 255, 255, 0.03)'; btn.style.transform = 'translateY(0)'; });
  ...
  resumeBtn.innerHTML = `<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" style="margin-right: 12px;"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path><polyline points="7 10 12 15 17 10"></polyline><line x1="12" y1="15" x2="12" y2="3"></line></svg><span>${translations[lang].resume.downloadResume}</span>`;
  ctaCluster.appendChild(primaryRow);
  ctaCluster.appendChild(resumeBtn);
  content.appendChild(ctaCluster);
  const spacerTop = document.createElement('div');
  spacerTop.style.flex = '1.5';
  section.appendChild(spacerTop);
  section.appendChild(content);
  const spacerBottom = document.createElement('div');
  spacerBottom.style.flex = '0.5';
